...
st.title("📽️ Pharma Safety Twin Playback – v11 Conditional Siren Duration")
...
if play:
    for ts in time_steps:
        ...
        # Check reactor status and start siren only once when it turns orange
        ...
        if reactor_status in ["Warning", "High Risk"] and not siren_started:
            audio_area.markdown(play_siren(), unsafe_allow_html=True)
            siren_started = True
